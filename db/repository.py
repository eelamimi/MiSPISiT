...
class Repository:
    ...
    def __init_database(self):
        ...
        try:
            ...
            Repository.__init_questions(cursor, pol_first, 'POL', 3)
            Repository.__init_questions(cursor, chl_first, 'CHL', 2)
            Repository.__init_questions(cursor, umn_first, 'UMN', 3)

            Repository.__init_questions(cursor, pol_second, 'POL', 6)
            Repository.__init_questions(cursor, chl_second, 'CHL', 3)
            Repository.__init_questions(cursor, umn_second, 'UMN', 5)

            Repository.__init_questions(cursor, pol_third, 'POL', 9)
            Repository.__init_questions(cursor, chl_third, 'CHL', 5)
            Repository.__init_questions(cursor, umn_third, 'UMN', 7)
    ...
    def __init_results(cursor):
        results = (
            (1,  1, 'РД 1.1.', '2025-09-01 12:00:00', 9, 5, 7, 0.6, 0.5, 1.0),
            (2,  1, 'РД 1.2.', '2025-09-08 12:00:00', 9, 5, 7, 0.7, 0.5, 1.0),
            (3,  1, 'РД 1.3.', '2025-09-15 12:00:00', 9, 5, 7, 0.8, 0.7, 0.3),
            (4,  1, 'РД 2.1.', '2025-09-22 12:00:00', 9, 5, 7, 0.8, 0.8, 0.5),
            (5,  1, 'РД 2.2.', '2025-09-29 12:00:00', 9, 5, 7, 0.9, 0.6, 1.0),
            (6,  1, 'РД 2.3.', '2025-10-06 12:00:00', 9, 5, 7, 0.7, 0.5, 0.4),
            (7,  1, 'РД 2.4.', '2025-10-13 12:00:00', 9, 5, 7, 0.6, 0.6, 0.3),
            (8,  1, 'РД 3.1.', '2025-10-20 12:00:00', 9, 5, 7, 0.8, 0.7, 0.5),
            (9,  1, 'РД 3.2.', '2025-10-27 12:00:00', 9, 5, 7, 0.9, 0.8, 0.6),
            (10, 1, 'РД 3.3.', '2025-11-03 12:00:00', 9, 5, 7, 0.7, 0.7, 0.5),
            (11, 1, 'РД 4.1.', '2025-11-10 12:00:00', 9, 5, 7, 0.6, 0.6, 0.4),
            (12, 1, 'РД 4.2.', '2025-11-17 12:00:00', 9, 5, 7, 1.0, 1.0, 1.0),
            (13, 1, 'РД 4.3.', '2025-11-24 12:00:00', 9, 5, 7, 1.0, 1.0, 1.0),
            (14, 1, 'РД 5.1.', '2025-12-01 12:00:00', 9, 5, 7, 1.0, 1.0, 1.0),
            (15, 1, 'РД 5.2.', '2025-12-08 12:00:00', 9, 5, 7, 1.0, 1.0, 1.0),
        )
        cursor.executemany('''
            INSERT INTO `Results`
